...
// bricks
const bricksColorTexture = textureLoader.load("/textures/bricks/roughness.jpg");
...
const graveMaterial = new THREE.MeshStandardMaterial({ color: "#323232" });
...
// Ghost
const ghost1 = new THREE.PointLight("#D27328", 2, 3);
...
const tick = () => {
  ...
  ghost2.position.y = Math.sin(ghost2Angle * 3) + Math.sin(elapsedTime * 3);
  ...
  ghost3.position.y = Math.sin(ghost2Angle * 3) + Math.sin(elapsedTime * 2.5);
